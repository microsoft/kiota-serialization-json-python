...
class TestIntersectionWrapperParseTests:
    ...
    def test_parse_intersection_type_complex_property1(self):
    ...
    def test_parse_intersection_type_complex_property3(self):
        json_string = '[{"id": "8f841f30-e6e3-439a-a812-ebd369559c36",\
            "display_name": "John Doe", "age": 32, "gpa": 3.9, "office_location": "dunhill"},\
    ...
    def test_parse_intersection_type_string_value(self):
    ...
    def test_serializes_intersection_type_string_value(self):
        writer = JsonSerializationWriter()
        model = InterSectionType(string_value="John Doe")
    ...
    def test_serializes_intersection_type(self):
        writer = JsonSerializationWriter()
        composed_type1 = User(
    ...
    def test_serializes_intersection_type_complex_property2(self):
        writer = JsonSerializationWriter()
    ...
    def test_serializes_intersection_type_complex_property3(self):
        writer = JsonSerializationWriter()
        user_1 = User(
